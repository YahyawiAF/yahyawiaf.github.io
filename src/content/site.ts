...
export const projects: Project[] = [
  ...
  },
  {
    ...
    images: [
      ...
      "/projects/erp-supply/app-mobile-entrepot-1.png",
      "/projects/erp-supply/app-mobile-entrepot-2.png",
      "/projects/erp-supply/app-mobile-entrepot-3.png",
      "/projects/erp-supply/app-mobile-entrepot-4.png",
      "/projects/erp-supply/app-mobile-commercial-1.png",
      "/projects/erp-supply/app-mobile-commercial-2.png",
      "/projects/erp-supply/app-mobile-commercial-3.png",
    ],
    apps: [
      { name: "Web Admin", kind: "web", status: "ready" },
      { name: "Mobile Admin", kind: "mobile", status: "soon" },
      { name: "Entrepôt", kind: "mobile", status: "ready" },
      { name: "Commercial", kind: "mobile", status: "ready" },
      { name: "Chauffeur", kind: "mobile", status: "soon" },
      { name: "Caisse / POS", kind: "mobile", status: "soon" },
    ],
    pipeline: [
      "Data",
      "Analyse",
