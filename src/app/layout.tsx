...
export const metadata: Metadata = {
  title: "ALGOSAMA — Software services that level up your product",
  description:
    "ALGOSAMA is a Tunisia-based IT services studio building web apps, mobile apps, and modernized legacy systems.",
